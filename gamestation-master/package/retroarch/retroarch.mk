...
RETROARCH_DEPENDENCIES = host-pkgconf gamestation-system
...
ifeq ($(GAMESTATION_SYSTEM_VERSION)),rpi2)
	LIBRETRO_BOARD=$(GAMESTATION_SYSTEM_VERSION)
endif
ifeq ($(GAMESTATION_SYSTEM_VERSION)),rpi3)
	LIBRETRO_BOARD=$(GAMESTATION_SYSTEM_VERSION)
endif
