################################################################################
#
# gamestation-romfs-mastersystem
#
################################################################################
...
GAMESTATION_ROMFS_MASTERSYSTEM_SOURCE = 
GAMESTATION_ROMFS_MASTERSYSTEM_SITE = 
GAMESTATION_ROMFS_MASTERSYSTEM_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_MASTERSYSTEM = mastersystem
SYSTEM_XML_MASTERSYSTEM = $(@D)/$(SYSTEM_NAME_MASTERSYSTEM).xml
# System rom path
SOURCE_ROMDIR_MASTERSYSTEM = $(GAMESTATION_ROMFS_MASTERSYSTEM_PKGDIR)/roms
...
define CONFIGURE_MAIN_MASTERSYSTEM_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_MASTERSYSTEM),Sega Master System / Mark III,$(SYSTEM_NAME_MASTERSYSTEM),.sms .SMS .zip .ZIP,mastersystem,mastersystem)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_GENESISPLUSGX)$(BR2_PACKAGE_LIBRETRO_PICODRIVE),)
define CONFIGURE_MASTERSYSTEM_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_MASTERSYSTEM),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_GENESISPLUSGX),y)
define CONFIGURE_MASTERSYSTEM_LIBRETRO_GENESISPLUSGX_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_MASTERSYSTEM),genesisplusgx)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_PICODRIVE),y)
define CONFIGURE_MASTERSYSTEM_LIBRETRO_PICODRIVE_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_MASTERSYSTEM),picodrive)
endef
endif

define CONFIGURE_MASTERSYSTEM_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_MASTERSYSTEM))
endef
endif
...
define CONFIGURE_MAIN_MASTERSYSTEM_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_MASTERSYSTEM),$(SOURCE_ROMDIR_MASTERSYSTEM),$(@D))
endef
endif

define GAMESTATION_ROMFS_MASTERSYSTEM_CONFIGURE_CMDS
