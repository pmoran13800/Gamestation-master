...
GAMESTATION_ROMFS_AMSTRADCPC_SOURCE = 
GAMESTATION_ROMFS_AMSTRADCPC_SITE = 
GAMESTATION_ROMFS_AMSTRADCPC_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_AMSTRADCPC = amstradcpc
SYSTEM_XML_AMSTRADCPC = $(@D)/$(SYSTEM_NAME_AMSTRADCPC).xml
# System rom path
SOURCE_ROMDIR_AMSTRADCPC = $(GAMESTATION_ROMFS_AMSTRADCPC_PKGDIR)/roms
...
define CONFIGURE_MAIN_AMSTRADCPC_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_AMSTRADCPC),AmstradCPC,$(SYSTEM_NAME_AMSTRADCPC),.dsk .DSK .zip .ZIP .kcr .KCR,amstradcpc,amstradcpc)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_CAP32)$(BR2_PACKAGE_LIBRETRO_CROCODS),)
define CONFIGURE_AMSTRADCPC_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_AMSTRADCPC),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_CROCODS),y)
define CONFIGURE_AMSTRADCPC_LIBRETRO_CROCODS_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_AMSTRADCPC),crocods)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_CAP32),y)
define CONFIGURE_AMSTRADCPC_LIBRETRO_CAP32_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_AMSTRADCPC),cap32)
endef
endif

define CONFIGURE_AMSTRADCPC_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_AMSTRADCPC))
endef
endif
...
define CONFIGURE_MAIN_AMSTRADCPC_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_AMSTRADCPC),$(SOURCE_ROMDIR_AMSTRADCPC),$(@D))
endef
endif

define GAMESTATION_ROMFS_AMSTRADCPC_CONFIGURE_CMDS
