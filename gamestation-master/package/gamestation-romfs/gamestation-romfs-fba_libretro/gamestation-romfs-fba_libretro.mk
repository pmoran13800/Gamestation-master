################################################################################
#
# gamestation-romfs-fba_libretro
#
################################################################################
...
GAMESTATION_ROMFS_FBA_LIBRETRO_SOURCE = 
GAMESTATION_ROMFS_FBA_LIBRETRO_SITE = 
GAMESTATION_ROMFS_FBA_LIBRETRO_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_FBA_LIBRETRO = fba_libretro
SYSTEM_XML_FBA_LIBRETRO = $(@D)/$(SYSTEM_NAME_FBA_LIBRETRO).xml
# System rom path
SOURCE_ROMDIR_FBA_LIBRETRO = $(GAMESTATION_ROMFS_FBA_LIBRETRO_PKGDIR)/roms
...
define CONFIGURE_MAIN_FBA_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_FBA_LIBRETRO),FBA_LIBRETRO,$(SYSTEM_NAME_FBA_LIBRETRO),.zip .ZIP .fba .FBA .7z .7Z,arcade,fba_libretro)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_FBA),)
define CONFIGURE_FBA_LIBRETRO_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_FBA_LIBRETRO),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_FBA),y)
define CONFIGURE_FBA_LIBRETRO_LIBRETRO_FBA_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_FBA_LIBRETRO),fba)
endef
endif

define CONFIGURE_FBA_LIBRETRO_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_FBA_LIBRETRO))
endef
endif
...
define CONFIGURE_MAIN_FBA_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_FBA_LIBRETRO),$(SOURCE_ROMDIR_FBA_LIBRETRO),$(@D))
endef
endif

define GAMESTATION_ROMFS_FBA_LIBRETRO_CONFIGURE_CMDS
