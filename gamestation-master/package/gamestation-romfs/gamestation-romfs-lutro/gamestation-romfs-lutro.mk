...
GAMESTATION_ROMFS_LUTRO_SOURCE = 
GAMESTATION_ROMFS_LUTRO_SITE = 
GAMESTATION_ROMFS_LUTRO_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_LUTRO = lutro
SYSTEM_XML_LUTRO = $(@D)/$(SYSTEM_NAME_LUTRO).xml
# System rom path
SOURCE_ROMDIR_LUTRO = $(GAMESTATION_ROMFS_LUTRO_PKGDIR)/roms
...
define CONFIGURE_MAIN_LUTRO_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_LUTRO),Lutro,$(SYSTEM_NAME_LUTRO),.zip .ZIP .lua .LUA .lutro .LUTRO,lutro,lutro)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_LUTRO),)
define CONFIGURE_LUTRO_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_LUTRO),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_LUTRO),y)
define CONFIGURE_LUTRO_LIBRETRO_LUTRO_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_LUTRO),lutro)
endef
endif

define CONFIGURE_LUTRO_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_LUTRO))
endef
endif
...
define CONFIGURE_MAIN_LUTRO_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_LUTRO),$(SOURCE_ROMDIR_LUTRO),$(@D))
endef
endif

define GAMESTATION_ROMFS_LUTRO_CONFIGURE_CMDS
