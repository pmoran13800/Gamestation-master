...
GAMESTATION_ROMFS_ATARI5200_SOURCE = 
GAMESTATION_ROMFS_ATARI5200_SITE = 
GAMESTATION_ROMFS_ATARI5200_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_ATARI5200 = atari5200
SYSTEM_XML_ATARI5200 = $(@D)/$(SYSTEM_NAME_ATARI5200).xml
# System rom path
SOURCE_ROMDIR_ATARI5200 = $(GAMESTATION_ROMFS_ATARI5200_PKGDIR)/roms
...
define CONFIGURE_MAIN_ATARI5200_START
        $(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_ATARI5200),Atari 5200,$(SYSTEM_NAME_ATARI5200),.xfd .XFD .atr .ATR .atx .ATX .cdm .CDM .cas .CAS .bin .BIN .a52 .A52 .xex .XEX .zip .ZIP,atari5200,atari5200)
endef


ifneq ($(BR2_PACKAGE_LIBRETRO_ATARI800),)
define CONFIGURE_ATARI5200_LIBRETRO_START
        $(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_ATARI5200),libretro)
endef


ifeq ($(BR2_PACKAGE_LIBRETRO_ATARI800),y)
define CONFIGURE_ATARI5200_LIBRETRO_ATARI800_DEF
        $(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_ATARI5200),atari800)
endef
endif

define CONFIGURE_ATARI5200_LIBRETRO_END
        $(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_ATARI5200))
endef
endif

define CONFIGURE_MAIN_ATARI5200_END
        $(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_ATARI5200),$(SOURCE_ROMDIR_ATARI5200),$(@D))
endef
endif

define GAMESTATION_ROMFS_ATARI5200_CONFIGURE_CMDS
