...
GAMESTATION_ROMFS_SNES_SOURCE = 
GAMESTATION_ROMFS_SNES_SITE = 
GAMESTATION_ROMFS_SNES_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_SNES = snes
SYSTEM_XML_SNES = $(@D)/$(SYSTEM_NAME_SNES).xml
# System rom path
SOURCE_ROMDIR_SNES = $(GAMESTATION_ROMFS_SNES_PKGDIR)/roms
...
define CONFIGURE_MAIN_SNES_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_SNES),Super Nintendo Entertainment System,$(SYSTEM_NAME_SNES),.smc .sfc .SMC .SFC .zip .ZIP .mgd .MGD,snes,snes)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_CATSFC)$(BR2_PACKAGE_LIBRETRO_POCKETSNES)$(BR2_PACKAGE_LIBRETRO_SNES9X_NEXT)$(BR2_PACKAGE_LIBRETRO_SNES9X),)
define CONFIGURE_SNES_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_SNES),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_SNES9X_NEXT),y)
define CONFIGURE_SNES_LIBRETRO_SNES9X_NEXT_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_SNES),snes9x_next)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_CATSFC),y)
define CONFIGURE_SNES_LIBRETRO_CATSFC_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_SNES),catsfc)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_SNES9X),y)
define CONFIGURE_SNES_LIBRETRO_SNES9X_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_SNES),snes9x)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_POCKETSNES),y)
define CONFIGURE_SNES_LIBRETRO_POCKETSNES_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_SNES),pocketsnes)
endef
endif

define CONFIGURE_SNES_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_SNES))
endef
endif
...
define CONFIGURE_MAIN_SNES_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_SNES),$(SOURCE_ROMDIR_SNES),$(@D))
endef
endif

define GAMESTATION_ROMFS_SNES_CONFIGURE_CMDS
