...
GAMESTATION_ROMFS_PRBOOM_SOURCE = 
GAMESTATION_ROMFS_PRBOOM_SITE = 
GAMESTATION_ROMFS_PRBOOM_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_PRBOOM = prboom
SYSTEM_XML_PRBOOM = $(@D)/$(SYSTEM_NAME_PRBOOM).xml
# System rom path
SOURCE_ROMDIR_PRBOOM = $(GAMESTATION_ROMFS_PRBOOM_PKGDIR)/roms
...
define CONFIGURE_MAIN_PRBOOM_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_PRBOOM),PrBoom,$(SYSTEM_NAME_PRBOOM),.wad .WAD,prboom,prboom)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_PRBOOM),)
define CONFIGURE_PRBOOM_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_PRBOOM),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_PRBOOM),y)
define CONFIGURE_PRBOOM_LIBRETRO_PRBOOM_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_PRBOOM),prboom)
endef
endif

define CONFIGURE_PRBOOM_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_PRBOOM))
endef
endif
...
define CONFIGURE_MAIN_PRBOOM_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_PRBOOM),$(SOURCE_ROMDIR_PRBOOM),$(@D))
endef
endif

define GAMESTATION_ROMFS_PRBOOM_CONFIGURE_CMDS
