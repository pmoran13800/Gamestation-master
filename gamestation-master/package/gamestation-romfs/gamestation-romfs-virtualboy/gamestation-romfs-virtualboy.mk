...
GAMESTATION_ROMFS_VIRTUALBOY_SOURCE = 
GAMESTATION_ROMFS_VIRTUALBOY_SITE = 
GAMESTATION_ROMFS_VIRTUALBOY_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_VIRTUALBOY = virtualboy
SYSTEM_XML_VIRTUALBOY = $(@D)/$(SYSTEM_NAME_VIRTUALBOY).xml
# System rom path
SOURCE_ROMDIR_VIRTUALBOY = $(GAMESTATION_ROMFS_VIRTUALBOY_PKGDIR)/roms
...
define CONFIGURE_MAIN_VIRTUALBOY_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_VIRTUALBOY),Virtual Boy,$(SYSTEM_NAME_VIRTUALBOY),.vb .VB .zip .ZIP,virtualboy,virtualboy)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_BEETLE_VB),)
define CONFIGURE_VIRTUALBOY_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_VIRTUALBOY),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_BEETLE_VB),y)
define CONFIGURE_VIRTUALBOY_LIBRETRO_MEDNAFEN_VB_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_VIRTUALBOY),mednafen_vb)
endef
endif

define CONFIGURE_VIRTUALBOY_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_VIRTUALBOY))
endef
endif
...
define CONFIGURE_MAIN_VIRTUALBOY_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_VIRTUALBOY),$(SOURCE_ROMDIR_VIRTUALBOY),$(@D))
endef
endif

define GAMESTATION_ROMFS_VIRTUALBOY_CONFIGURE_CMDS
