...
Then extract the "Databases" and "Machines" folders and add them to the bios folder of your gamestation.

- FMSX :
You must have these following files, available with fmsx distribution, in the bios folder of your gamestation :
CARTS.SHA
CYRILLIC.FNT
DISK.ROM
FMPAC.ROM
