################################################################################
#
# gamestation-romfs-colecovision
#
################################################################################
...
GAMESTATION_ROMFS_COLECOVISION_SOURCE = 
GAMESTATION_ROMFS_COLECOVISION_SITE = 
GAMESTATION_ROMFS_COLECOVISION_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_COLECOVISION = colecovision
SYSTEM_XML_COLECOVISION = $(@D)/$(SYSTEM_NAME_COLECOVISION).xml
# System rom path
SOURCE_ROMDIR_COLECOVISION = $(GAMESTATION_ROMFS_COLECOVISION_PKGDIR)/roms
...
define CONFIGURE_MAIN_COLECOVISION_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_COLECOVISION),Colecovision,$(SYSTEM_NAME_COLECOVISION),.col .COL .zip .ZIP,colecovision,colecovision)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_BLUEMSX),)
define CONFIGURE_COLECOVISION_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_COLECOVISION),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_BLUEMSX),y)
define CONFIGURE_COLECOVISION_LIBRETRO_BLUEMSX_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_COLECOVISION),bluemsx)
endef
endif

define CONFIGURE_COLECOVISION_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_COLECOVISION))
endef
endif
...
define CONFIGURE_MAIN_COLECOVISION_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_COLECOVISION),$(SOURCE_ROMDIR_COLECOVISION),$(@D))
endef
endif

define GAMESTATION_ROMFS_COLECOVISION_CONFIGURE_CMDS
