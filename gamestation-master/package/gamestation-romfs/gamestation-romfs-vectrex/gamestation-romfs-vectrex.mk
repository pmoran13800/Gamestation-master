...
GAMESTATION_ROMFS_VECTREX_SOURCE = 
GAMESTATION_ROMFS_VECTREX_SITE = 
GAMESTATION_ROMFS_VECTREX_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_VECTREX = vectrex
SYSTEM_XML_VECTREX = $(@D)/$(SYSTEM_NAME_VECTREX).xml
# System rom path
SOURCE_ROMDIR_VECTREX = $(GAMESTATION_ROMFS_VECTREX_PKGDIR)/roms
...
define CONFIGURE_MAIN_VECTREX_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_VECTREX),Vectrex,$(SYSTEM_NAME_VECTREX),.zip .ZIP .vec .VEC,vectrex,vectrex)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_VECX),)
define CONFIGURE_VECTREX_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_VECTREX),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_VECX),y)
define CONFIGURE_VECTREX_LIBRETRO_VECX_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_VECTREX),vecx)
endef
endif

define CONFIGURE_VECTREX_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_VECTREX))
endef
endif
...
define CONFIGURE_MAIN_VECTREX_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_VECTREX),$(SOURCE_ROMDIR_VECTREX),$(@D))
endef
endif

define GAMESTATION_ROMFS_VECTREX_CONFIGURE_CMDS
