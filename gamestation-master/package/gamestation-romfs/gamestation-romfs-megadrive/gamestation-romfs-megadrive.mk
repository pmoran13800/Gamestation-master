...
GAMESTATION_ROMFS_MEGADRIVE_SOURCE = 
GAMESTATION_ROMFS_MEGADRIVE_SITE = 
GAMESTATION_ROMFS_MEGADRIVE_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_MEGADRIVE = megadrive
SYSTEM_XML_MEGADRIVE = $(@D)/$(SYSTEM_NAME_MEGADRIVE).xml
# System rom path
SOURCE_ROMDIR_MEGADRIVE = $(GAMESTATION_ROMFS_MEGADRIVE_PKGDIR)/roms
...
define CONFIGURE_MAIN_MEGADRIVE_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_MEGADRIVE),Sega Megadrive,$(SYSTEM_NAME_MEGADRIVE),.md .MD .bin .BIN .zip .ZIP .gen .GEN .smd .SMD,megadrive,megadrive)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_GENESISPLUSGX)$(BR2_PACKAGE_LIBRETRO_PICODRIVE),)
define CONFIGURE_MEGADRIVE_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_MEGADRIVE),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_GENESISPLUSGX),y)
define CONFIGURE_MEGADRIVE_LIBRETRO_GENESISPLUSGX_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_MEGADRIVE),genesisplusgx)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_PICODRIVE),y)
define CONFIGURE_MEGADRIVE_LIBRETRO_PICODRIVE_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_MEGADRIVE),picodrive)
endef
endif

define CONFIGURE_MEGADRIVE_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_MEGADRIVE))
endef
endif
...
define CONFIGURE_MAIN_MEGADRIVE_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_MEGADRIVE),$(SOURCE_ROMDIR_MEGADRIVE),$(@D))
endef
endif

define GAMESTATION_ROMFS_MEGADRIVE_CONFIGURE_CMDS
