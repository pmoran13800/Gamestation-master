...
GAMESTATION_ROMFS_SG1000_SOURCE = 
GAMESTATION_ROMFS_SG1000_SITE = 
GAMESTATION_ROMFS_SG1000_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_SG1000 = sg1000
SYSTEM_XML_SG1000 = $(@D)/$(SYSTEM_NAME_SG1000).xml
# System rom path
SOURCE_ROMDIR_SG1000 = $(GAMESTATION_ROMFS_SG1000_PKGDIR)/roms
...
define CONFIGURE_MAIN_SG1000_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_SG1000),Sega SG1000,$(SYSTEM_NAME_SG1000),.sg .SG .zip .ZIP,sg1000,sg1000)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_GENESISPLUSGX),)
define CONFIGURE_SG1000_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_SG1000),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_GENESISPLUSGX),y)
define CONFIGURE_SG1000_LIBRETRO_GENESISPLUSGX_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_SG1000),genesisplusgx)
endef
endif

define CONFIGURE_SG1000_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_SG1000))
endef
endif
...
define CONFIGURE_MAIN_SG1000_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_SG1000),$(SOURCE_ROMDIR_SG1000),$(@D))
endef
endif

define GAMESTATION_ROMFS_SG1000_CONFIGURE_CMDS
