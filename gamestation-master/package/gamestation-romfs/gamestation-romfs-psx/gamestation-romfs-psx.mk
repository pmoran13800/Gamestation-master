...
GAMESTATION_ROMFS_PSX_SOURCE = 
GAMESTATION_ROMFS_PSX_SITE = 
GAMESTATION_ROMFS_PSX_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_PSX = psx
SYSTEM_XML_PSX = $(@D)/$(SYSTEM_NAME_PSX).xml
# System rom path
SOURCE_ROMDIR_PSX = $(GAMESTATION_ROMFS_PSX_PKGDIR)/roms
...
define CONFIGURE_MAIN_PSX_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_PSX),Sony Playstation 1,$(SYSTEM_NAME_PSX),.img .IMG .pbp .PBP .cue .CUE .iso .ISO .ccd .CCD .cbn .CBN .m3u .M3U .chd .CHD,psx,psx)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_PCSX)$(BR2_PACKAGE_LIBRETRO_BEETLE_PSX)$(BR2_PACKAGE_LIBRETRO_BEETLE_PSX_HW),)
define CONFIGURE_PSX_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_PSX),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_BEETLE_PSX),y)
define CONFIGURE_PSX_LIBRETRO_MEDNAFEN_PSX_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_PSX),mednafen_psx)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_BEETLE_PSX_HW),y)
define CONFIGURE_PSX_LIBRETRO_MEDNAFEN_PSX_HW_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_PSX),mednafen_psx_hw)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_PCSX),y)
define CONFIGURE_PSX_LIBRETRO_PCSX_REARMED_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_PSX),pcsx_rearmed)
endef
endif

define CONFIGURE_PSX_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_PSX))
endef
endif
...
define CONFIGURE_MAIN_PSX_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_PSX),$(SOURCE_ROMDIR_PSX),$(@D))
endef
endif

define GAMESTATION_ROMFS_PSX_CONFIGURE_CMDS
