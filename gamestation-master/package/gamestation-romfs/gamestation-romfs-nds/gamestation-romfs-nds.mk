...
GAMESTATION_ROMFS_NDS_SOURCE = 
GAMESTATION_ROMFS_NDS_SITE = 
GAMESTATION_ROMFS_NDS_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_NDS = nds
SYSTEM_XML_NDS = $(@D)/$(SYSTEM_NAME_NDS).xml
# System rom path
SOURCE_ROMDIR_NDS = $(GAMESTATION_ROMFS_NDS_PKGDIR)/roms
...
define CONFIGURE_MAIN_NDS_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_NDS),Nintendo DS,$(SYSTEM_NAME_NDS),.nds .NDS .zip .ZIP,nds,nds)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_DESMUME)$(BR2_PACKAGE_LIBRETRO_MELONDS),)
define CONFIGURE_NDS_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_NDS),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_DESMUME),y)
define CONFIGURE_NDS_LIBRETRO_DESMUME_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_NDS),desmume)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_MELONDS),y)
define CONFIGURE_NDS_LIBRETRO_MELONDS_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_NDS),melonds)
endef
endif

define CONFIGURE_NDS_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_NDS))
endef
endif
...
define CONFIGURE_MAIN_NDS_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_NDS),$(SOURCE_ROMDIR_NDS),$(@D))
endef
endif

define GAMESTATION_ROMFS_NDS_CONFIGURE_CMDS
