...
GAMESTATION_ROMFS_X68000_SOURCE = 
GAMESTATION_ROMFS_X68000_SITE = 
GAMESTATION_ROMFS_X68000_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_X68000 = x68000
SYSTEM_XML_X68000 = $(@D)/$(SYSTEM_NAME_X68000).xml
# System rom path
SOURCE_ROMDIR_X68000 = $(GAMESTATION_ROMFS_X68000_PKGDIR)/roms
...
define CONFIGURE_MAIN_X68000_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_X68000),Sharp X68000,$(SYSTEM_NAME_X68000),.dim .DIM .zip .ZIP .img .IMG .d88 .D88 .88d .88D .hdm .HDM .dup .DUP .2hd .2HD .xdf .XDF .hdf .HDF .cmd .CMD .m3u .M3U,x68000,x68000)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_PX68K),)
define CONFIGURE_X68000_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_X68000),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_PX68K),y)
define CONFIGURE_X68000_LIBRETRO_PX68K_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_X68000),px68k)
endef
endif

define CONFIGURE_X68000_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_X68000))
endef
endif
...
define CONFIGURE_MAIN_X68000_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_X68000),$(SOURCE_ROMDIR_X68000),$(@D))
endef
endif

define GAMESTATION_ROMFS_X68000_CONFIGURE_CMDS
