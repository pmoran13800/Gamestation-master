...
GAMESTATION_ROMFS_SEGACD_SOURCE = 
GAMESTATION_ROMFS_SEGACD_SITE = 
GAMESTATION_ROMFS_SEGACD_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_SEGACD = segacd
SYSTEM_XML_SEGACD = $(@D)/$(SYSTEM_NAME_SEGACD).xml
# System rom path
SOURCE_ROMDIR_SEGACD = $(GAMESTATION_ROMFS_SEGACD_PKGDIR)/roms
...
define CONFIGURE_MAIN_SEGACD_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_SEGACD),Sega CD,$(SYSTEM_NAME_SEGACD),.cue .CUE .iso .ISO .chd .CHD,segacd,segacd)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_GENESISPLUSGX)$(BR2_PACKAGE_LIBRETRO_PICODRIVE),)
define CONFIGURE_SEGACD_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_SEGACD),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_GENESISPLUSGX),y)
define CONFIGURE_SEGACD_LIBRETRO_GENESISPLUSGX_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_SEGACD),genesisplusgx)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_PICODRIVE),y)
define CONFIGURE_SEGACD_LIBRETRO_PICODRIVE_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_SEGACD),picodrive)
endef
endif

define CONFIGURE_SEGACD_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_SEGACD))
endef
endif
...
define CONFIGURE_MAIN_SEGACD_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_SEGACD),$(SOURCE_ROMDIR_SEGACD),$(@D))
endef
endif

define GAMESTATION_ROMFS_SEGACD_CONFIGURE_CMDS
