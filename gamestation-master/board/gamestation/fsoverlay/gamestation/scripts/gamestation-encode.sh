...
#    * based on the mac address of the ethernet card (so, not for rpi0) - not secure for people having access to the local network, but for people having access to your external drive or gamestation.conf file
