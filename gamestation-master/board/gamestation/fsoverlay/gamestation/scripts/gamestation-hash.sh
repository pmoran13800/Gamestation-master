...
pRoms=/gamestation/share/roms
hashFilePath=/gamestation/share/system/configs/hashes
testMode=
...
knownExtensions=`xmllint -xpath "string(/systemList/system/extension[../name=\"$system\"])" /gamestation/share_init/system/.emulationstation/es_systems.cfg`
