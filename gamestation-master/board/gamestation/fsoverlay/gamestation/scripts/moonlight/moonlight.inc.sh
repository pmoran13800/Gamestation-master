#!/bin/bash
moonlightConf=/gamestation/share/system/configs/moonlight
moonlightSeparator=";"
...
function getURL {
  ...
  then
    ...
    [ ! -s $keydir/uniqueid.dat ] && { echo "ERROR getURL(): your gamestation is not yet paired with a GeForce Now compatible PC" >&2 ; exit 1 ; }
