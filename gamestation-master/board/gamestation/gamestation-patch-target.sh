...
convert "${TARGET_DIR}/gamestation/system/resources/splash/logo.png" -fill white -pointsize 60 -gravity center -annotate +0+0 "Upgrading the system\nPlease wait..." "${TARGET_DIR}/gamestation/system/resources/splash/logo-upgrade.png" || exit 1

# Splash video subtitle
echo -e "1\n00:00:00,000 --> 00:00:03,000\n${TGVERSION}" > "${TARGET_DIR}/gamestation/system/resources/splash/gamestationintro.srt"
...
# Changelog
cp "$BR2_EXTERNAL_GAMESTATION_PATH/CHANGELOG.md" "${TARGET_DIR}/gamestation/gamestation.changelog"
