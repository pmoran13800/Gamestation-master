...
GAMESTATION_ROMFS_GB_SOURCE = 
GAMESTATION_ROMFS_GB_SITE = 
GAMESTATION_ROMFS_GB_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_GB = gb
SYSTEM_XML_GB = $(@D)/$(SYSTEM_NAME_GB).xml
# System rom path
SOURCE_ROMDIR_GB = $(GAMESTATION_ROMFS_GB_PKGDIR)/roms
...
define CONFIGURE_MAIN_GB_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_GB),Game Boy,$(SYSTEM_NAME_GB),.gb .GB .zip .ZIP,gb,gb)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_GAMBATTE)$(BR2_PACKAGE_LIBRETRO_TGBDUAL)$(BR2_PACKAGE_LIBRETRO_MGBA),)
define CONFIGURE_GB_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_GB),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_MGBA),y)
define CONFIGURE_GB_LIBRETRO_MGBA_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_GB),mgba)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_GAMBATTE),y)
define CONFIGURE_GB_LIBRETRO_GAMBATTE_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_GB),gambatte)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_TGBDUAL),y)
define CONFIGURE_GB_LIBRETRO_TGBDUAL_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_GB),tgbdual)
endef
endif

define CONFIGURE_GB_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_GB))
endef
endif
...
define CONFIGURE_MAIN_GB_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_GB),$(SOURCE_ROMDIR_GB),$(@D))
endef
endif

define GAMESTATION_ROMFS_GB_CONFIGURE_CMDS
