...
GAMESTATION_ROMFS_WSWAN_SOURCE = 
GAMESTATION_ROMFS_WSWAN_SITE = 
GAMESTATION_ROMFS_WSWAN_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_WSWAN = wswan
SYSTEM_XML_WSWAN = $(@D)/$(SYSTEM_NAME_WSWAN).xml
# System rom path
SOURCE_ROMDIR_WSWAN = $(GAMESTATION_ROMFS_WSWAN_PKGDIR)/roms
...
define CONFIGURE_MAIN_WSWAN_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_WSWAN),WonderSwan,$(SYSTEM_NAME_WSWAN),.ws .WS .wsc .WSC .zip .ZIP,wonderswan,wonderswan)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_BEETLE_WSWAN),)
define CONFIGURE_WSWAN_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_WSWAN),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_BEETLE_WSWAN),y)
define CONFIGURE_WSWAN_LIBRETRO_MEDNAFEN_WSWAN_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_WSWAN),mednafen_wswan)
endef
endif

define CONFIGURE_WSWAN_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_WSWAN))
endef
endif
...
define CONFIGURE_MAIN_WSWAN_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_WSWAN),$(SOURCE_ROMDIR_WSWAN),$(@D))
endef
endif

define GAMESTATION_ROMFS_WSWAN_CONFIGURE_CMDS
