...
GAMESTATION_ROMFS_ATARI7800_SOURCE = 
GAMESTATION_ROMFS_ATARI7800_SITE = 
GAMESTATION_ROMFS_ATARI7800_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_ATARI7800 = atari7800
SYSTEM_XML_ATARI7800 = $(@D)/$(SYSTEM_NAME_ATARI7800).xml
# System rom path
SOURCE_ROMDIR_ATARI7800 = $(GAMESTATION_ROMFS_ATARI7800_PKGDIR)/roms
...
define CONFIGURE_MAIN_ATARI7800_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_ATARI7800),Atari 7800,$(SYSTEM_NAME_ATARI7800),.a78 .A78 .bin .BIN .zip .ZIP,atari7800,atari7800)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_PROSYSTEM),)
define CONFIGURE_ATARI7800_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_ATARI7800),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_PROSYSTEM),y)
define CONFIGURE_ATARI7800_LIBRETRO_PROSYSTEM_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_ATARI7800),prosystem)
endef
endif

define CONFIGURE_ATARI7800_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_ATARI7800))
endef
endif
...
define CONFIGURE_MAIN_ATARI7800_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_ATARI7800),$(SOURCE_ROMDIR_ATARI7800),$(@D))
endef
endif

define GAMESTATION_ROMFS_ATARI7800_CONFIGURE_CMDS
