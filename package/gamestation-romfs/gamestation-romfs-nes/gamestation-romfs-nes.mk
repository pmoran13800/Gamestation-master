...
GAMESTATION_ROMFS_NES_SOURCE = 
GAMESTATION_ROMFS_NES_SITE = 
GAMESTATION_ROMFS_NES_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_NES = nes
SYSTEM_XML_NES = $(@D)/$(SYSTEM_NAME_NES).xml
# System rom path
SOURCE_ROMDIR_NES = $(GAMESTATION_ROMFS_NES_PKGDIR)/roms
...
define CONFIGURE_MAIN_NES_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_NES),Nintendo Entertainment System,$(SYSTEM_NAME_NES),.nes .NES .zip .ZIP,nes,nes)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_FCEUMM)$(BR2_PACKAGE_LIBRETRO_FCEUNEXT)$(BR2_PACKAGE_LIBRETRO_NESTOPIA)$(BR2_PACKAGE_LIBRETRO_QUICKNES),)
define CONFIGURE_NES_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_NES),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_FCEUNEXT),y)
define CONFIGURE_NES_LIBRETRO_FCEUNEXT_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_NES),fceunext)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_QUICKNES),y)
define CONFIGURE_NES_LIBRETRO_QUICKNES_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_NES),quicknes)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_FCEUMM),y)
define CONFIGURE_NES_LIBRETRO_FCEUMM_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_NES),fceumm)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_NESTOPIA),y)
define CONFIGURE_NES_LIBRETRO_NESTOPIA_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_NES),nestopia)
endef
endif

define CONFIGURE_NES_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_NES))
endef
endif
...
define CONFIGURE_MAIN_NES_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_NES),$(SOURCE_ROMDIR_NES),$(@D))
endef
endif

define GAMESTATION_ROMFS_NES_CONFIGURE_CMDS
