...
GAMESTATION_ROMFS_3DO_SOURCE = 
GAMESTATION_ROMFS_3DO_SITE = 
GAMESTATION_ROMFS_3DO_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_3DO = 3do
SYSTEM_XML_3DO = $(@D)/$(SYSTEM_NAME_3DO).xml
# System rom path
SOURCE_ROMDIR_3DO = $(GAMESTATION_ROMFS_3DO_PKGDIR)/roms
...
define CONFIGURE_MAIN_3DO_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_3DO),Panasonic 3DO,$(SYSTEM_NAME_3DO),.iso .ISO .cue .CUE .chd .CHD,3do,3do)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_4DO),)
define CONFIGURE_3DO_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_3DO),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_4DO),y)
define CONFIGURE_3DO_LIBRETRO_4DO_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_3DO),4do)
endef
endif

define CONFIGURE_3DO_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_3DO))
endef
endif
...
define CONFIGURE_MAIN_3DO_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_3DO),$(SOURCE_ROMDIR_3DO),$(@D))
endef
endif

define GAMESTATION_ROMFS_3DO_CONFIGURE_CMDS
