...
GAMESTATION_ROMFS_WSWANC_SOURCE = 
GAMESTATION_ROMFS_WSWANC_SITE = 
GAMESTATION_ROMFS_WSWANC_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_WSWANC = wswanc
SYSTEM_XML_WSWANC = $(@D)/$(SYSTEM_NAME_WSWANC).xml
# System rom path
SOURCE_ROMDIR_WSWANC = $(GAMESTATION_ROMFS_WSWANC_PKGDIR)/roms
...
define CONFIGURE_MAIN_WSWANC_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_WSWANC),WonderSwan Color,$(SYSTEM_NAME_WSWANC),.ws .WS .wsc .WSC .zip .ZIP,wonderswancolor,wonderswancolor)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_BEETLE_WSWAN),)
define CONFIGURE_WSWANC_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_WSWANC),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_BEETLE_WSWAN),y)
define CONFIGURE_WSWANC_LIBRETRO_MEDNAFEN_WSWAN_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_WSWANC),mednafen_wswan)
endef
endif

define CONFIGURE_WSWANC_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_WSWANC))
endef
endif
...
define CONFIGURE_MAIN_WSWANC_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_WSWANC),$(SOURCE_ROMDIR_WSWANC),$(@D))
endef
endif

define GAMESTATION_ROMFS_WSWANC_CONFIGURE_CMDS
