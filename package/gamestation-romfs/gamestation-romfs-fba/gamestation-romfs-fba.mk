...
GAMESTATION_ROMFS_FBA_SOURCE = 
GAMESTATION_ROMFS_FBA_SITE = 
GAMESTATION_ROMFS_FBA_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_FBA = fba
SYSTEM_XML_FBA = $(@D)/$(SYSTEM_NAME_FBA).xml
# System rom path
SOURCE_ROMDIR_FBA = $(GAMESTATION_ROMFS_FBA_PKGDIR)/roms
...
define CONFIGURE_MAIN_FBA_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_FBA),Final Burn Alpha,$(SYSTEM_NAME_FBA),.zip .ZIP .fba .FBA,arcade,fba)
endef

ifneq ($(BR2_PACKAGE_PIFBA),)
define CONFIGURE_FBA_FBA2X_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_FBA),fba2x)
endef
ifeq ($(BR2_PACKAGE_PIFBA),y)
define CONFIGURE_FBA_FBA2X_FBA2X_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_FBA),fba2x)
endef
endif

define CONFIGURE_FBA_FBA2X_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_FBA))
endef
endif
...
define CONFIGURE_MAIN_FBA_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_FBA),$(SOURCE_ROMDIR_FBA),$(@D))
endef
endif

define GAMESTATION_ROMFS_FBA_CONFIGURE_CMDS
