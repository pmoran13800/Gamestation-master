...
GAMESTATION_ROMFS_ATARI2600_SOURCE = 
GAMESTATION_ROMFS_ATARI2600_SITE = 
GAMESTATION_ROMFS_ATARI2600_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_ATARI2600 = atari2600
SYSTEM_XML_ATARI2600 = $(@D)/$(SYSTEM_NAME_ATARI2600).xml
# System rom path
SOURCE_ROMDIR_ATARI2600 = $(GAMESTATION_ROMFS_ATARI2600_PKGDIR)/roms
...
define CONFIGURE_MAIN_ATARI2600_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_ATARI2600),Atari 2600,$(SYSTEM_NAME_ATARI2600),.a26 .A26 .bin .BIN .zip .ZIP,atari2600,atari2600)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_STELLA),)
define CONFIGURE_ATARI2600_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_ATARI2600),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_STELLA),y)
define CONFIGURE_ATARI2600_LIBRETRO_STELLA_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_ATARI2600),stella)
endef
endif

define CONFIGURE_ATARI2600_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_ATARI2600))
endef
endif
...
define CONFIGURE_MAIN_ATARI2600_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_ATARI2600),$(SOURCE_ROMDIR_ATARI2600),$(@D))
endef
endif

define GAMESTATION_ROMFS_ATARI2600_CONFIGURE_CMDS
