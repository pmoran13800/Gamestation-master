...
GAMESTATION_ROMFS_LYNX_SOURCE = 
GAMESTATION_ROMFS_LYNX_SITE = 
GAMESTATION_ROMFS_LYNX_INSTALL_STAGING = NO
# Set the system name
SYSTEM_NAME_LYNX = lynx
SYSTEM_XML_LYNX = $(@D)/$(SYSTEM_NAME_LYNX).xml
# System rom path
SOURCE_ROMDIR_LYNX = $(GAMESTATION_ROMFS_LYNX_PKGDIR)/roms
...
define CONFIGURE_MAIN_LYNX_START
	$(call GAMESTATION_ROMFS_CALL_ADD_SYSTEM,$(SYSTEM_XML_LYNX),Lynx,$(SYSTEM_NAME_LYNX),.zip .ZIP .lnx .LNX,atarilynx,lynx)
endef

ifneq ($(BR2_PACKAGE_LIBRETRO_HANDY)$(BR2_PACKAGE_LIBRETRO_BEETLE_LYNX),)
define CONFIGURE_LYNX_LIBRETRO_START
	$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_LYNX),libretro)
endef
ifeq ($(BR2_PACKAGE_LIBRETRO_HANDY),y)
define CONFIGURE_LYNX_LIBRETRO_HANDY_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_LYNX),handy)
endef
endif

ifeq ($(BR2_PACKAGE_LIBRETRO_BEETLE_LYNX),y)
define CONFIGURE_LYNX_LIBRETRO_MEDNAFEN_LYNX_DEF
	$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_LYNX),mednafen_lynx)
endef
endif

define CONFIGURE_LYNX_LIBRETRO_END
	$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_LYNX))
endef
endif
...
define CONFIGURE_MAIN_LYNX_END
	$(call GAMESTATION_ROMFS_CALL_END_SYSTEM,$(SYSTEM_XML_LYNX),$(SOURCE_ROMDIR_LYNX),$(@D))
endef
endif

define GAMESTATION_ROMFS_LYNX_CONFIGURE_CMDS
