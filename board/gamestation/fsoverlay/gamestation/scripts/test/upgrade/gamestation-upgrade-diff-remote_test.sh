...
upgradestatus="${basedir}/../../upgrade/gamestation-upgrade-diff-remote.sh"
...
when curl isCalled with "-f https://url-to-use.com/v1/upgrade/rpi1/gamestation.changelog?source=gamestation" thenExit 0
when curl isCalled with "-f https://url-to-use.com/v1/upgrade/rpi1/gamestation.version?source=gamestation" thenEcho "review-2"
...
when curl isCalled with "-f https://url-to-use.com/v1/upgrade/rpi1/gamestation.changelog?source=gamestation" thenEcho "- a news in review 2"
when curl isCalled with "-f https://url-to-use.com/v1/upgrade/rpi1/gamestation.version?source=gamestation" thenEcho "review-2"
...
when curl isCalled with "-f https://url-to-use.com/v1/upgrade/rpi1/gamestation.changelog?source=gamestation" thenEcho "- a news in review 1"
when curl isCalled with "-f https://url-to-use.com/v1/upgrade/rpi1/gamestation.version?source=gamestation" thenEcho "review-2"
