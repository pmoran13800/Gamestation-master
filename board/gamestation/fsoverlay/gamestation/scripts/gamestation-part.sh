...
# it cannot work if the root is an nfs device or an initramfs device, which is not supported by gamestation

# gamestation has 3 partitions
...
case "${PARTNAME}" in
    ...
    *)
	...
	echo "  system: the gamestation system partition" >&2
