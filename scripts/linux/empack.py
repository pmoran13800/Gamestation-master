...
class EmPack:
    def __init__(self, system, extensions, emcoredef, fullname=None, platform=None, theme=None):
        ...
        self._PackageName = "gamestation-romfs-{}".format(self._System)
        self._PackageDir = "package/gamestation-romfs/{}".format(self._PackageName)
    ...
    def addemulator(self, emulator):
        ...
        returnStr = "ifneq ({},)\n".format(cond)
        returnStr += "define {}\n".format(defineName)
        returnStr += "\t$(call GAMESTATION_ROMFS_CALL_START_EMULATOR,$(SYSTEM_XML_{}),{})\n".format(self._SystemUpper, emulatorLo)
        returnStr += "endef\n"
    ...
    def addcore(self, emulator, core, brVar):
        ...
        endef
        GAMESTATION_ROMFS_system_CONFIGURE_CMDS += $(XXX)
        ...
        returnStr = "ifeq ($({}),y)\n".format(brVar)
        returnStr += "define {}\n".format(defineName)
        returnStr += "\t$(call GAMESTATION_ROMFS_CALL_ADD_CORE,$(SYSTEM_XML_{}),{})\n".format( self._SystemUpper,coreLo)
        returnStr += "endef\n"
        returnStr += "endif\n\n"
    ...
    def endemulator(self, emulator):
        ...
        returnStr = "define {}\n".format(defineName)
        returnStr += "\t$(call GAMESTATION_ROMFS_CALL_END_EMULATOR,$(SYSTEM_XML_{}))\n".format(self._SystemUpper)
        returnStr += "endef\n"
        returnStr += "endif\n\n"
    ...
    def writemakefile(self):
        ...
        if self._SingleMode:
            skeletonFile = 'package/gamestation-romfs/gamestation-romfs_single_emulator.skeleton'
        else:
            skeletonFile = 'package/gamestation-romfs/gamestation-romfs_multicores.skeleton'
    ...
    def writeconfigin(self):
        ...
        configIn = "config BR2_PACKAGE_GAMESTATION_ROMFS_{}\n".format(self._SystemUpper)
        configIn += "\tbool \"gamestation-romfs-{}\"\n".format(self._System)
        #~ configIn += "\tdefault y\n"
        configIn += "\tselect BR2_PACKAGE_GAMESTATION_ROMS\n"
        configIn += "\tdepends on {}\n".format(dependsOn)
        configIn += "\thelp\n"
    ...
    def copyoverlaydir(self):
        ...
        overlaydir = "board/gamestation/fsoverlay/gamestation/share_init/roms/{}".format(self._System)
    ...
    def finalword(self):
        # Ask the user to add himself to gamestation-rom.mk the following lines:
        print "\nNow you will have to edit :\n"
        # print "  * package/gamestation-romfs/gamestation-romfs/Config.in and add :"
        # print "\tdepends on BR2_PACKAGE_GAMESTATION_ROMFS_{}\n\n".format(SYSTEM_UPPER)
        print "  * package/gamestation-romfs/gamestation-romfs/gamestation-romfs.mk :"
        ...
        defLine += "\tGAMESTATION_ROMFS_DEPENDENCIES += {}\n".format(self._PackageName)
        defLine += "endif"
        print defLine
        print "\n  * Add a source to package/gamestation-romfs/Config.in :"
        print " source {}/Config.in".format(self._PackageDir)
        print "\n  * Add dependencies to package/gamestation-romfs/gamestation-romfs/Config.in :"
        print "\n\t  || BR2_PACKAGE_GAMESTATION_ROMFS_{}".format(self._SystemUpper)
        print "\n  * Add to the emulators/cores Config.in:\n"
        print "\tselect BR2_PACKAGE_GAMESTATION_ROMFS_{}".format(self._SystemUpper)
